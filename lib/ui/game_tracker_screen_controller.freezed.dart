...
mixin _$GameTrackerScreenState {
 ...
 List<MatchModel>? get allMatches => throw _privateConstructorUsedError; SportLeague? get league => throw _privateConstructorUsedError; MatchModel? get match => throw _privateConstructorUsedError; List<FootballMatchIncidentModel>? get pastFootballIncidents => throw _privateConstructorUsedError; List<BasketballMatchIncidentModel>? get pastBasketballIncidents => throw _privateConstructorUsedError; List<FootballMatchIncidentModel>? get footballIncidents => throw _privateConstructorUsedError; List<BasketballMatchIncidentModel>? get basketballIncidents => throw _privateConstructorUsedError; FootballMatchIncidentDriveListModel? get selectedFootballPlaysList => throw _privateConstructorUsedError; bool get matchIsDisabled => throw _privateConstructorUsedError; bool get matchIsCovered => throw _privateConstructorUsedError;
...
@useResult
$Res call({
 List<MatchModel>? allMatches, SportLeague? league, MatchModel? match, List<FootballMatchIncidentModel>? pastFootballIncidents, List<BasketballMatchIncidentModel>? pastBasketballIncidents, List<FootballMatchIncidentModel>? footballIncidents, List<BasketballMatchIncidentModel>? basketballIncidents, FootballMatchIncidentDriveListModel? selectedFootballPlaysList, bool matchIsDisabled, bool matchIsCovered
});
...
@pragma('vm:prefer-inline') @override $Res call({Object? allMatches = freezed,Object? league = freezed,Object? match = freezed,Object? pastFootballIncidents = freezed,Object? pastBasketballIncidents = freezed,Object? footballIncidents = freezed,Object? basketballIncidents = freezed,Object? selectedFootballPlaysList = freezed,Object? matchIsDisabled = null,Object? matchIsCovered = null,}) {
...
as MatchModel?,pastFootballIncidents: freezed == pastFootballIncidents ? _value.pastFootballIncidents : pastFootballIncidents // ignore: cast_nullable_to_non_nullable
as List<FootballMatchIncidentModel>?,pastBasketballIncidents: freezed == pastBasketballIncidents ? _value.pastBasketballIncidents : pastBasketballIncidents // ignore: cast_nullable_to_non_nullable
as List<BasketballMatchIncidentModel>?,footballIncidents: freezed == footballIncidents ? _value.footballIncidents : footballIncidents // ignore: cast_nullable_to_non_nullable
...
as List<BasketballMatchIncidentModel>?,selectedFootballPlaysList: freezed == selectedFootballPlaysList ? _value.selectedFootballPlaysList : selectedFootballPlaysList // ignore: cast_nullable_to_non_nullable
...
as List<MatchModel>?,league: freezed == league ? _value.league : league // ignore: cast_nullable_to_non_nullable
as SportLeague?,match: freezed == match ? _value.match : match // ignore: cast_nullable_to_non_nullable
as MatchModel?,pastFootballIncidents: freezed == pastFootballIncidents ? _value._pastFootballIncidents : pastFootballIncidents // ignore: cast_nullable_to_non_nullable
as List<FootballMatchIncidentModel>?,pastBasketballIncidents: freezed == pastBasketballIncidents ? _value._pastBasketballIncidents : pastBasketballIncidents // ignore: cast_nullable_to_non_nullable
as List<BasketballMatchIncidentModel>?,footballIncidents: freezed == footballIncidents ? _value._footballIncidents : footballIncidents // ignore: cast_nullable_to_non_nullable
...
class _$GameTrackerScreenStateImpl  implements _GameTrackerScreenState {
  const _$GameTrackerScreenStateImpl({final  List<MatchModel>? allMatches, this.league, this.match, final  List<FootballMatchIncidentModel>? pastFootballIncidents, final  List<BasketballMatchIncidentModel>? pastBasketballIncidents, final  List<FootballMatchIncidentModel>? footballIncidents, final  List<BasketballMatchIncidentModel>? basketballIncidents, this.selectedFootballPlaysList, this.matchIsDisabled = false, this.matchIsCovered = true}): _allMatches = allMatches,_pastFootballIncidents = pastFootballIncidents,_pastBasketballIncidents = pastBasketballIncidents,_footballIncidents = footballIncidents,_basketballIncidents = basketballIncidents;
...
@override List<BasketballMatchIncidentModel>? get pastBasketballIncidents {
  final value = _pastBasketballIncidents;
  if (value == null) return null;
  if (_pastBasketballIncidents is EqualUnmodifiableListView) return _pastBasketballIncidents;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(value);
}
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _$GameTrackerScreenStateImpl&&const DeepCollectionEquality().equals(other._allMatches, _allMatches)&&(identical(other.league, league) || other.league == league)&&(identical(other.match, match) || other.match == match)&&const DeepCollectionEquality().equals(other._pastFootballIncidents, _pastFootballIncidents)&&const DeepCollectionEquality().equals(other._pastBasketballIncidents, _pastBasketballIncidents)&&const DeepCollectionEquality().equals(other._footballIncidents, _footballIncidents)&&const DeepCollectionEquality().equals(other._basketballIncidents, _basketballIncidents)&&(identical(other.selectedFootballPlaysList, selectedFootballPlaysList) || other.selectedFootballPlaysList == selectedFootballPlaysList)&&(identical(other.matchIsDisabled, matchIsDisabled) || other.matchIsDisabled == matchIsDisabled)&&(identical(other.matchIsCovered, matchIsCovered) || other.matchIsCovered == matchIsCovered));
}

@JsonKey(ignore: true)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_allMatches),league,match,const DeepCollectionEquality().hash(_pastFootballIncidents),const DeepCollectionEquality().hash(_pastBasketballIncidents),const DeepCollectionEquality().hash(_footballIncidents),const DeepCollectionEquality().hash(_basketballIncidents),selectedFootballPlaysList,matchIsDisabled,matchIsCovered);
