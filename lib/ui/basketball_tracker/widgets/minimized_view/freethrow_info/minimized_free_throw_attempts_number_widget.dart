...
class MinimizedFreeThrowAttemptsNumberWidget extends ConsumerWidget {
  const MinimizedFreeThrowAttemptsNumberWidget(
      {super.key,
  ...
  Widget _buildChildWidget(GameTrackerSkin skin) {
    ...
    return AutoSizeText(
      ...
      style: skin.textStyles.basketballHeaderBody1Medium
          .copyWith(color: skin.colors.grey1, height: 1.1),
