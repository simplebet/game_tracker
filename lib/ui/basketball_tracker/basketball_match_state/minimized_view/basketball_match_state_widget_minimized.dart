...
import 'basketball_game_clock_widget_minimized.dart';
import 'basketball_team_state_widget_minimized.dart';

class BasketballMatchStateWidgetMinimized extends ConsumerWidget {
  const BasketballMatchStateWidgetMinimized._({
  ...
  factory BasketballMatchStateWidgetMinimized.cbb(
      {required CollegeBasketballMatch match,
      required double maxWidth,
      required double maxHeight}) {
    return BasketballMatchStateWidgetMinimized._(
  ...
  factory BasketballMatchStateWidgetMinimized.nba(
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Flexible(
            flex: 4,
            child: BasketballTeamStateWidgetMinimized(
          ...
          Flexible(
            ...
            child: Container(
              ...
              child: BasketballGameClockWidgetMinimized(
                period: period,
                gameClock: gameClock,
                status: status,
                startTime: startTime,
