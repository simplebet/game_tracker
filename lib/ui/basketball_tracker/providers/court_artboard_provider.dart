...
final courtArtboardProvider = FutureProvider.autoDispose<Artboard>((ref) async {
  final file = await ref.watch(riveFileProvider.future);

  final artboard =
      file.artboardByName(BasketballTrackerRiveArtboards.court)?.instance();
  ...
  throw Exception('Court artboard not found');
});
