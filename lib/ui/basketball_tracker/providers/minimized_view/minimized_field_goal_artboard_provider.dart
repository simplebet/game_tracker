...
final minimizedFieldGoalArtboardProvider =
  ...
  final artboard = file.artboardByName(
      BasketballTrackerRiveArtboards.fieldGoalAttemptsMinimized);
  ...
  throw Exception(
      '${BasketballTrackerRiveStateMachines.fieldGoalAttempts} artboard not found');
});
