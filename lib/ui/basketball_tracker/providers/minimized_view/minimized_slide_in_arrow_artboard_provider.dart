...
final minimizedSlideInArrowArtboardProvider =
  ...
  final artboard = file
      .artboardByName(BasketballTrackerRiveArtboards.slideInArrowsMinimized)
      ?.instance();
  ...
  throw Exception(
      '${BasketballTrackerRiveArtboards.slideInArrowsMinimized} artboard not found');
});
